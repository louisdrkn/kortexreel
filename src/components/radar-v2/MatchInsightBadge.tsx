...
export function MatchInsightBadge({
  ...
  // TACTICAL HUD: Unified badge styling
  const getBadgeStyle = (score: number) => {
    // Always return the "Neon/Glass" style regardless of score,
    // but vary the intensity/color slightly if needed.
    // For now, we use a consistent "Insight" look.
    return "bg-indigo-500/10 text-indigo-300 border-indigo-500/20 shadow-[0_0_10px_rgba(99,102,241,0.1)]";
  };
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-slate-500">
                    Ressemble à{" "}
                    <span className="font-medium">{similarClient.name}</span>
