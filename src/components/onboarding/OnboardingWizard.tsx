...
import { 
  Brain, Check, Upload, Globe, Sparkles, Link2, 
  ArrowRight, Shield, Zap, FileText, Key
} from "lucide-react";
...
export function OnboardingWizard({ userName = "Utilisateur", onComplete, onSkip }: OnboardingWizardProps) {
  ...
  const handleWebsiteScan = async () => {
    ...
    setData(prev => ({
      ...
      companyPitch: `${companyName} accompagne les entreprises dans leur transformation digitale avec des solutions innovantes et sur-mesure.`
    }));
  ...
  const allConnected = connections.magileads && connections.unipile && connections.openai;
            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="mb-8 overflow-hidden rounded-2xl border border-slate-100 bg-gradient-to-br from-slate-50 to-white p-6 shadow-lg shadow-slate-100/50">
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: typewriterComplete ? 1 : 0, y: typewriterComplete ? 0 : 10 }}
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <p className="mb-8 text-slate-500">
                    Glissez votre Pitch Deck ou votre Offre (PDF). L'IA va en extraire votre Cible Idéale.
                  </p>
                  ...
                  {!isAnalyzing && detectedICP.length === 0 ? (
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-400">PDF, DOCX, PPTX (max 10 Mo)</p>
                      <input
                        ...
                        {analysisLabels.map((label, index) => (
                          <motion.p
                            ...
                            animate={{ 
                              ...
                              color: index === currentLabel ? "#7c3aed" : "#64748b"
                            }}
                            className="text-sm transition-colors"
                          >
                            {index < currentLabel && <Check className="inline h-3 w-3 mr-1 text-emerald-500" />}
                            {label}
                          </motion.p>
                        ))}
                      </div>
                    ...
                    >
                      <div className="rounded-2xl border border-emerald-100 bg-emerald-50/50 p-6">
                        <div className="mb-4 flex items-center gap-2">
                          ...
                          <span className="font-medium text-emerald-700">Cibles Idéales Détectées</span>
                        </div>
              ...
              {currentStep === 2 && (
                ...
                >
                  ...
                  <p className="mb-8 text-slate-500">
                    Connectez vos services pour activer l'intelligence commerciale.
                  </p>
